...
{
    public abstract class IdentityVerificationServiceWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static IdentityVerificationServiceWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(IdentityVerificationServiceWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<IdentityVerificationServiceDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<IdentityVerificationServiceDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<IdentityVerificationServiceDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<IdentityVerificationServiceDbContext, Task<T>> func)
        {
            T result;
