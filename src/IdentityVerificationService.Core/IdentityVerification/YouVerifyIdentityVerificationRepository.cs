...
{
    public class YouVerifyIdentityVerificationRepository : DomainService, IIdentityVerificationRepository
    {
        private readonly HttpClient _httpClient;
        private readonly IConfiguration _configuration;

        public YouVerifyIdentityVerificationRepository(HttpClient httpClient, IConfiguration configuration)
        {
