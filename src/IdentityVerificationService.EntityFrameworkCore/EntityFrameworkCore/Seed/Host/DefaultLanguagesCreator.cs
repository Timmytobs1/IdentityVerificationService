...
namespace IdentityVerificationService.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly IdentityVerificationServiceDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = IdentityVerificationServiceConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(IdentityVerificationServiceDbContext context)
        {
            _context = context;
        }
